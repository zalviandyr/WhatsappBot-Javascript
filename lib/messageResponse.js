const messageResponse = {
    ...
    helpOwner:
        ...
        + '*!groups*\n'
        + '*!requests*\n'
        + '_(dev)_*!bc* [groupid] [message]' // TODO add this function
        + '_(dev)_*!bcgroups* [message]' // TODO add this function
        + '_(dev)_*!state* [state]' // TODO add this function
    ...
    nsfw: {
        ...
        error: 'Kayakny ada yang salah nih master',
        pending: 'Bot lagi tidak bisa mengirim pesan lewat dm yang bukan kontak\ntunggu kelanjutan yang enak-enaknya'
    },
    ...
    lewd: {
        ...
        wait: 'Tunggu yaa~\nLagi diproses nih',
        success: 'Check private chat master',
        caption: 'Neh master',
        error: 'Kayakny ada yang salah nih'
    },
