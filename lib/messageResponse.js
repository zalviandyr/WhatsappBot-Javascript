module.exports = messageResponse = {
    ...
    request: {
        help: 'Kok gk ada request-an nya master\nContoh: !request bisa anu gtu',
        success: "Baik master, terima kasih atas masukannya. Ntar dibaca oleh orang itu",
    ...
    quoteMaker: {
        help: "Contohnya: \n!quotemaker :Contoh:Editor berkelas",
        wait: "Tunggu yaa~\nLagi diproses nih",
        success: "neh master",
        error: "Kayakny ada yang salah nih master",
    },
    ...
    igStalk: {
        help: "Tambahkan usernamenya tanpa @ master\nContohnya: !igstalk zukronalviandy11",
        wait: "Tunggu yaa~\nLagi diproses nih",
        error: "Kayakny ada yang salah nih master",
    },
    ...
    creator:
        "Orang itu yang telah menaungi salah satu grup",

    about:
        "❤❤ Inori Yuzuriha Bot ❤❤",

    notFound:
        "Command tidak ditemukan, ulangi lagi yaa~",
}