const {optionValue} = require('./helpers')
...
const messageResponse = {
    ...
    state: {
        ...
        notRegistered: 'Sepertinya ini penyelundupan master\n'
            + 'Coba request dulu ke *Grandmaster* agar dibuka aksesnya\n'
    ...
    creator: '\'Grandmaster\' yang ada di salah satu grup',
