...
const messageResponse = {
    help:
        ...
        + '*!speech* [kata]\n'
        + '*!kanyequote*\n'
        + '_(dev)_*nulis*' // todo add this feature
        + '\n*---------Study---------*\n'
        + '*!tugas* [command] [desc]\n'
        + '\n*---------Group---------*\n'
        + '*!kick* [mention]\n'
    ...
    report: {
        help:
            'Kok gk ada report nya master\n_Contoh: !request ada bug di fitur_',
        success:
            `Baik master, terima kasih atas masukannya. Ntar dibaca oleh ${stringValues.ownerName}`,
    ...
    ytAudio: {
        ...
        error2: 'Kayaknya ada yang salah nih master'
    },
    ...
    // todo fix ig, igstories, igstalk, lirik dan brainly
    announcement: 'Karena dalam proses migrasi ke cloud\n'
        + 'Ada beberapa fitur yang terkena forbidden (403)\n'
        + '[ig, igstories, igstalk, lirik, brainly]'
}
