...
const functionResponse = {
    ...
    speech: async (client, message, args) => {
        if (args.length === 0) {
            ...
            const url = 'https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/ce3d3b7b-679f-436f-9b2a-1873729665e0/v1/synthesize?voice=en-US_EmilyV3Voice'
            const username = 'apikey'
            const password = 'eFqDzlg1HOxCUJHvJQioQnJswV8IcoF_KCl6l4pLtBWs'
            const word = args.toString().replace(/,/g, ' ')
